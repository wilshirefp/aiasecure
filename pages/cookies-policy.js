...
export default function CookiesPolicy() {
  return (
    ...
    <Head>
        ...
        <meta name="description" content="AIA Securities Cookies Policy" />
  ...
  <div className={styles.wrapper}>
    ...
    <div className={styles.items}>
        ...
        <p className={styles.info}>By using this website (collectively with any content, functionality, or services offered on or through this website, the &ldquo;Website&ldquo;) you consent to the use of cookies in accordance with this Cookies Policy. You may have seen a pop-up to this effect on your first visit to the Website; although it may not appear on subsequent visits, you may withdraw your consent at any time by following the instructions below.</p>
        <p className={styles.modalTitle}>Disabling Cookies</p>
